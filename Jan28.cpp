...
https://www.youtube.com/watch?v=Lh0PXb3Hqik
    ...
    void addNum(int value) {
        ...
        if(just_bada!=mp.begin()){
            ...
            if(just_peeche->second >=value){
                return; //(1,4) 3 (5,8) --> 3 is already in range of 1 to 4 so no need to check
            }
        ...
        // corner case 3
        if(just_bada!=mp.end() && just_bada->first == value+1){
