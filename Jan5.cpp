...
Explaination:-
We will sort the 2d vector in the increasing order w.r.t the first element.
  1. We will check either the lastpoint i.e array[0][1] is greater then array[1][0] if it is then we can say that only one arrow can burst these two ballons.
  else if not then we can say that it cant burst so we will increase the count of the arrows.
